package com.elysium.softwork.forum.presentation.views.feed
...
import com.elysium.softwork.forum.application.viewmodel.ForumViewModel
...
import com.elysium.softwork.forum.presentation.components.CategoryChips
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            LazyColumn(
                ...
                items(items = posts, key = { it.id }) { post ->
                    PostCard(post = post, onClick = { onOpenThread(post.id) })
                }
            }
        }
