package com.elysium.softwork.forum.presentation.navigation
...
import com.elysium.softwork.forum.presentation.views.feed.ForumScreen
import com.elysium.softwork.forum.presentation.views.newpost.NewPostScreen
import com.elysium.softwork.forum.presentation.views.thread.ThreadScreen

/**
 * Route catalog for the Forum bounded context. The feed route is also the bottom-nav
 * destination, so [FEED] is referenced from
 * [com.elysium.softwork.shared.presentation.navigation.MainNavigation] when wiring the
 * "Forum" tab.
 */
object ForumRoutes {
