 ...
 * @param trailingIcon optional composable rendered after the text.
 * @param isError marks the field as invalid; switches the border to [Danger].
 * @param singleLine when true, the text field is restricted to a single horizontal line.
 * @param minLines the minimum height in terms of visible lines of text.
 * @param keyboardOptions IME configuration.
 * @param visualTransformation transform applied to the displayed text.
 */
@Composable
